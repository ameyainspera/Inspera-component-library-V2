...
Inter for all UI text (weights 400, 500, 600). Noto Sans Mono for
...
| Style | Class | Size | Weight | Line height | Notes |
| --- | --- | --- | --- | --- | --- |
| `body.mdRegular` | `.inspera-body-md-regular` | 16px | 400 | 1.25 | Line height fixed at 20px |
| `body.mdMedium` | `.inspera-body-md-medium` | 16px | 500 | 1.25 | Line height fixed at 20px |
| `body.caption` | `.inspera-caption` | 12px | 400 | 1.2 |  |
| `body.paragraph` | `.inspera-paragraph` | 16px | 400 | 1.5 | Long-form running text |

#### Special

| Style | Class | Size | Weight | Line height | Notes |
| --- | --- | --- | --- | --- | --- |
| `special.serif` | `.inspera-serif` | 16px | 400 | 1.5 |  |
| `special.mono` | `.inspera-mono` | 16px | 400 | 1.5 |  |
